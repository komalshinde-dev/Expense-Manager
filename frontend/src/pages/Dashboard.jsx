...
const Dashboard = () => {
  ...
  // Ensure dark mode persists when navigating back to dashboard
  useEffect(() => {
          ...
          <div className="relative glass-dark backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-glass-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
              ...
              <div className="glass backdrop-blur-sm bg-white/10 rounded-xl p-4 border border-white/20">
                ...
                <p className="text-xl sm:text-2xl font-bold text-white break-words">₹{totalIncome.toLocaleString()}</p>
              </div>
              {/* Total Expenses Card */}
              <div className="glass backdrop-blur-sm bg-white/10 rounded-xl p-4 border border-white/20">
                <p className="text-cyan-100 text-sm font-medium mb-1">Total Expenses</p>
                <p className="text-xl sm:text-2xl font-bold text-white break-words">₹{totalExpenses.toLocaleString()}</p>
              </div>
              {/* Net Balance Card */}
              <div className="glass backdrop-blur-sm bg-white/10 rounded-xl p-4 border border-white/20">
                <p className="text-cyan-100 text-sm font-medium mb-1">Net Balance</p>
                <p className={`text-xl sm:text-2xl font-bold break-words ${netBalance >= 0 ? 'text-green-300' : 'text-red-300'}`}>
