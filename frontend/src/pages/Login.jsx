      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
        ...
        >
          ...
          <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 text-center leading-relaxed">
            Take control of your finances with smart tracking and AI-powered insights.
          </p>

          {/* Features List */}
          <div className="space-y-4">
            {[
              { icon: '📊', title: 'Smart Analytics', desc: 'Track spending patterns with AI insights' },
              { icon: '🤖', title: 'AI Assistant', desc: 'Get personalized financial advice' },
              { icon: '📈', title: 'Budget Management', desc: 'Set and monitor your budgets effortlessly' },
              { icon: '🔄', title: 'Recurring Expenses', desc: 'Never miss a subscription payment' }
            ].map((feature, index) => (
              <motion.div
                key={index}
