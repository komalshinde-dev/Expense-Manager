  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 dark:text-gray-400 text-lg mb-2">No recurring expenses found</p>
        ...
        {/* Info Box */}
        <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 dark:border-blue-400 p-4 mt-6 rounded">
          <div className="flex">
